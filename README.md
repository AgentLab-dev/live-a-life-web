...
- Thursday town play: a sprinkler duck-under in the Friends side yard, a play-cone weave on the east sidewalk, porch-step hops beside the house, a scarecrow tip-toe path on the south-west lawn, a croquet-wicket weave on the park lawn, and a kind acorn share from Friends to a park bench
