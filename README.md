...
- Thursday town play: a sprinkler duck-under on the Friends south sidewalk, a play-cone weave on the east sidewalk, porch-step hops on the Honey Cafe south lawn, a scarecrow tip-toe path on the south-west lawn, a croquet-wicket weave on the park lawn, and a kind acorn share from Friends to a park bench
